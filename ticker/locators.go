...
//nolint:gocritic // Value semantics let MaxNLocator satisfy Locator without requiring pointers.
...
//nolint:gocritic // Value semantics let AutoLocator satisfy Locator without requiring pointers.
