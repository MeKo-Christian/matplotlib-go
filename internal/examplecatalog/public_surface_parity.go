...
var publicSurfaceParityOverrides = []PublicSurfaceParity{
	...
	},
	{
		...
		Note:              "Box-plot rendering exists through typed data-driven boxplot helpers, but Matplotlib's precomputed-stat Axes.bxp convenience entry point remains a Phase 17.75.2 wrapper/API and fixture task.",
	},
	{
		...
		CatalogIDs:        []string{"stat_variants", "specialty_artists"},
		Note:              "Violin rendering exists for dataset-driven stats, but Matplotlib's precomputed-stat Axes.violin convenience entry point remains a Phase 17.75.2 wrapper/API and fixture task.",
	},
	{
	...
	},
	{
		...
		Status:            PublicSurfacePartial,
		ClosurePhase:      "17.75.2",
		GoFiles:           []string{"core/collection_line.go", "core/plot_variants.go"},
		CatalogIDs:        []string{"plot_variants"},
		Note:              "Horizontal line collections exist through lower-level collection helpers and pyplot, but a typed Axes.hlines convenience method with scalar broadcasting and fixture coverage remains a Phase 17.75.2 task.",
	},
	{
		...
		GoFiles:           []string{"core/collection_line.go", "core/plot_variants.go"},
		CatalogIDs:        []string{"plot_variants"},
		Note:              "Vertical line collections exist through lower-level collection helpers and pyplot, but a typed Axes.vlines convenience method with scalar broadcasting and fixture coverage remains a Phase 17.75.2 task.",
	},
	{
		...
		Note:              "Contour labels are available through typed contour construction options, but a source-compatible Axes.clabel-style entry point over contour-set handles remains a Phase 17.75.2 API and fixture task.",
	},
	{
	...
	},
	{
		...
		CatalogIDs:        []string{"mesh_contour_tri"},
		Note:              "Contour labels are available through typed contour construction options such as LabelLines and LabelFormatter. Matplotlib's post-hoc pyplot clabel mutation over an existing contour set remains omitted until contour-set handles expose a shared labeling API.",
	},
	{
		ID:                "pyplot-imread",
