...
var publicSurfaceParityOverrides = []PublicSurfaceParity{
	...
	},
	{
		...
		Note:              "Raw image file loading is intentionally not wrapped in core plotting APIs; callers should use Go's standard image.Decode or domain-specific decoders before passing matrix data or render.Image content to plotting helpers.",
	},
	{
		ID:                "image-imsave",
		...
		FeatureCoverageID: "image",
		Status:            PublicSurfaceIntentionalOmission,
		GoFiles:           []string{"core/savepng.go", "render/extensions.go"},
		Note:              "Matplotlib's array-oriented imsave helper is omitted; figure export is covered by SaveFig / SavePNG and raw image files should be written with Go image encoders.",
	},
	{
		ID:                "image-thumbnail",
