...
var publicSurfaceParityOverrides = []PublicSurfaceParity{
	...
	},
	{
		...
		Status:            PublicSurfaceIdiomaticEquivalent,
		GoFiles:           []string{"ticker/ticker.go"},
	...
	},
	{
		...
		GoFiles:           []string{"geom/geom.go", "transform/transform.go"},
		CatalogIDs:        []string{"transform_coordinates", "annotation_composition"},
		Note:              "Go AffineT provides immutable, chainable rotate, rotate-around, and skew builders in radians or degrees; scale, translate, and mutable matrix conveniences remain intentionally partial.",
	},
	{
	...
	},
	{
		...
		Note:              "Go ScaledTranslation transforms a fixed offset through a live child transform and propagates child invalidation.",
	},
	{
		...
		GoFiles:           []string{"transform/transform.go", "transform/graph.go"},
		CatalogIDs:        []string{"transform_coordinates"},
		Note:              "Go TransformWrapper keeps a stable graph node while its 2D child is replaced and propagates child/replacement invalidation.",
	},
	{
	...
	},
	{
		...
		FeatureCoverageID: "transforms",
		Status:            PublicSurfacePartial,
		GoFiles:           []string{"ticker/ticker.go", "transform/scale_registry.go"},
		CatalogIDs:        []string{"axes_control_surface"},
	...
	},
	{
		...
		Note:              "Stateful pyplot CMap delegates named colormap lookup to the Go color registry, including Matplotlib listed maps and reversed variants. Remaining partial scope is Matplotlib's lut resampling parameter and global default-cmap mutation behavior.",
	},
	{
		ID:                "pyplot-set-cmap",
	...
	},
	{
		...
		Status:            PublicSurfacePartial,
		GoFiles:           []string{"pyplot/pyplot.go", "canvas/canvas.go"},
		Note:              "Stateful pyplot CurrentFigManager returns the cached or newly-created manager for the current figure. Remaining partial scope is Matplotlib's numeric figure manager activation and GUI window semantics.",
	},
	{
		...
		Note:              "Go creates figure managers lazily through CurrentFigManager, Show, Draw, and the configured backend manager factory. Matplotlib's pyplot new_figure_manager numeric-id factory wrapper and manager activation semantics remain partial.",
	},
	{
		ID:                "pyplot-connect",
	...
	},
	{
		...
		FeatureCoverageID: "pyplot-state",
		Status:            PublicSurfacePartial,
		GoFiles:           []string{"pyplot/pyplot.go", "ticker/locators.go", "ticker/formatters.go"},
	...
	},
	{
		...
		FeatureCoverageID: "pyplot-state",
		Status:            PublicSurfacePartial,
		GoFiles:           []string{"pyplot/pyplot.go", "ticker/formatters.go"},
	...
	},
	{
		...
		FeatureCoverageID: "widgets-events-animation",
		Status:            PublicSurfaceIdiomaticEquivalent,
		GoFiles:           []string{"core/artist.go", "widgets/widgets_common.go", "canvas/widget_interaction.go"},
		Note:              "Go uses typed structs in package widgets instead of Matplotlib's mutable Widget base class.",
	},
	{
		...
		Status:            PublicSurfaceIdiomaticEquivalent,
		GoFiles:           []string{"core/artist.go", "widgets/widgets_common.go", "canvas/widget_interaction.go"},
		Note:              "Axes ownership is represented by typed widgets constructors rather than a public AxesWidget inheritance base.",
	},
	{
		ID:                "button-widget",
	...
	},
	{
		...
		FeatureCoverageID: "widgets-events-animation",
		Status:            PublicSurfaceIdiomaticEquivalent,
		GoFiles:           []string{"widgets/slider.go", "widgets/rangeslider.go", "canvas/widget_interaction.go"},
	...
	},
	{
		...
		FeatureCoverageID: "widgets-events-animation",
		Status:            PublicSurfaceIdiomaticEquivalent,
		GoFiles:           []string{"widgets/lassoselector.go", "canvas/widget_interaction.go"},
	...
	},
	{
		...
		FeatureCoverageID: "widgets-events-animation",
		Status:            PublicSurfaceIntentionalOmission,
		GoFiles:           []string{"widgets/selectors_common.go", "canvas/widget_interaction.go"},
...
var publicSurfaceParityRules = []publicSurfaceParityRule{
	...
	},
	{
		...
		featureCoverageID: "axis-ticker-scale",
		status:            PublicSurfacePartial,
		goFiles:           []string{"ticker/ticker.go", "dates/date_tick.go", "core/units.go"},
