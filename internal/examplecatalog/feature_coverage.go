...
var featureCoverageRows = []FeatureCoverage{
	...
	},
	{
		...
		CatalogIDs:              []string{"basic_line", "scatter_basic", "scatter_gallery", "bar_basic", "hist_basic", "mesh_contour_tri", "triangulation_gallery", "stat_variants"},
		ExampleIDs:              []string{"basic_line", "scatter_basic", "scatter_gallery", "bar_basic", "hist_basic", "mesh_contour_tri", "triangulation_gallery", "stat_variants"},
		WebDemoIDs:              []string{"lines", "scatter", "bars", "fills", "errorbars", "histogram", "axes", "mesh", "statistics", "variants", "vectors", "triangulation"},
	...
	},
	{
		...
		WebDemoIDs:              []string{"composition", "subplots", "axes_grid1"},
		GoEquivalent:            CoverageImplemented,
		ParityFixture:           CoverageImplemented,
		UserShowcase:            CoverageImplemented,
		BrowserDemo:             CoveragePartial,
	...
	},
	{
		...
		GoFiles:                 []string{"core/axis.go", "dates/date_tick.go", "core/units.go", "transform/scale_registry.go"},
	...
	},
	{
		...
		WebDemoIDs:              []string{"annotations", "composition", "subplots"},
		GoEquivalent:            CoveragePartial,
		ParityFixture:           CoverageImplemented,
		UserShowcase:            CoveragePartial,
		BrowserDemo:             CoveragePartial,
	...
	},
	{
		...
		WebDemoIDs:              []string{"heatmap", "matrix"},
		GoEquivalent:            CoverageImplemented,
		ParityFixture:           CoverageImplemented,
		UserShowcase:            CoveragePartial,
		BrowserDemo:             CoveragePartial,
	...
	},
	{
		...
		WebDemoIDs:              []string{"colorbars", "composition", "heatmap", "matrix"},
		GoEquivalent:            CoveragePartial,
		ParityFixture:           CoverageImplemented,
		UserShowcase:            CoveragePartial,
		BrowserDemo:             CoveragePartial,
	...
	},
	{
		...
		GoFiles:                 []string{"widgets/button.go", "widgets/slider.go", "widgets/rangeslider.go", "widgets/checkbuttons.go", "widgets/radiobuttons.go", "widgets/textbox.go", "widgets/selectors_common.go", "widgets/widgets_common.go", "canvas/widget_interaction.go", "canvas/dispatcher.go", "canvas/navigation.go", "canvas/picker.go", "canvas/scheduler.go", "animation/animation.go", "animation/writer_pillow.go", "animation/writer_apng.go", "animation/writer_html.go"},
		CatalogIDs:              []string{"widgets_gallery", "animation_gallery"},
		ExampleIDs:              []string{"widgets_gallery", "animation_gallery"},
		WebDemoIDs:              []string{"animation"},
		GoEquivalent:            CoveragePartial,
		ParityFixture:           CoveragePartial,
		UserShowcase:            CoveragePartial,
		BrowserDemo:             CoveragePartial,
		Breadth:                 BreadthThin,
		Notes:                   "Static widget artists, common selector workflows, event/navigation infrastructure, and FuncAnimation / ArtistAnimation-style playback exist; widgets_gallery and animation_gallery give catalog-visible widget/selector and animation setup coverage. The animation showcase is active in the WASM demo gallery and dependency-free GIF/APNG/HTML writers cover self-contained output; remaining partial scope is broader widget browser interaction and GUI-specific edge behavior.",
	},
	{
		...
		GoFiles:                 []string{"core/polar.go", "core/geo.go", "core/skew.go", "plot3d/axes.go", "core/axis_artist.go", "core/image_grid.go"},
		...
		WebDemoIDs:              []string{"polar", "projections", "toolkit", "mplot3d", "triangulation", "axisartist", "axes_grid1"},
		GoEquivalent:            CoveragePartial,
		ParityFixture:           CoverageImplemented,
		UserShowcase:            CoverageImplemented,
		BrowserDemo:             CoveragePartial,
