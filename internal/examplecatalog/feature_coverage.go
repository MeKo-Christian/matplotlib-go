...
var featureCoverageRows = []FeatureCoverage{
	...
	},
	{
		...
		BrowserDemo:             CoveragePending,
		Breadth:                 BreadthThin,
		Notes:                   "Static widget artists, common selector workflows, event/navigation infrastructure, and FuncAnimation / ArtistAnimation-style playback exist; widgets_gallery gives catalog-visible widget/selector coverage, while animation demos, browser demos, writer scope, and GUI-specific edge behavior remain pending.",
	},
	{
