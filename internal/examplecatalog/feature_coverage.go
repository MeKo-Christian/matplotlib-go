...
var featureCoverageRows = []FeatureCoverage{
	...
	},
	{
		...
		GoFiles:                 []string{"core/text.go", "core/legend.go", "core/anchored_text.go", "render/text_path.go"},
	...
	},
	{
		...
		GoFiles:                 []string{"core/widgets.go", "canvas/dispatcher.go", "canvas/navigation.go", "canvas/picker.go", "canvas/scheduler.go"},
		GoEquivalent:            CoveragePartial,
		ParityFixture:           CoveragePending,
		UserShowcase:            CoveragePending,
		BrowserDemo:             CoveragePending,
		Breadth:                 BreadthPending,
		Notes:                   "Static widget artists and event/navigation infrastructure exist; interactive widgets, selector workflows, WebAgg, and animation remain Phase 4-6 work.",
	},
	{
