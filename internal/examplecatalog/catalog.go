...
var cases = []Case{
	{ID: "basic_line", Topic: "lines", Title: "Basic Line", Showcase: true, GoBasicSmokeFamily: "line"},
	{ID: "joins_caps", Topic: "lines", Title: "Line Joins and Caps"},
	{ID: "dashes", Topic: "lines", Title: "Dash Patterns", Showcase: true},
	{ID: "scatter_basic", Topic: "scatter", Title: "Basic Scatter", Showcase: true, GoBasicSmokeFamily: "scatter"},
	...
	{ID: "bar_basic", Topic: "bar", Title: "Basic Bars", Showcase: true, SVGGoldenFamily: "bar", GoBasicSmokeFamily: "bar"},
	...
	{ID: "errorbar_basic", Topic: "errorbar", Title: "Error Bars", Showcase: true, SVGGoldenFamily: "errorbar", GoBasicSmokeFamily: "errorbar"},
	...
	{ID: "hist_basic", Topic: "histogram", Title: "Histogram Counts", Showcase: true, SVGGoldenFamily: "hist", GoBasicSmokeFamily: "histogram"},
	...
	{ID: "image_heatmap", Topic: "image", Title: "Heatmap Image", Showcase: true, SVGGoldenFamily: "image", GoBasicSmokeFamily: "image"},
	...
	{ID: "colorbar_composition", Topic: "colorbar", Title: "Colorbar Composition", Showcase: true, GoBasicSmokeFamily: "colorbar", MinPSNR: 32.0, MaxMeanAbs: 16.0},
	{ID: "annotation_composition", Topic: "annotation", Title: "Annotations", Showcase: true, GoBasicSmokeFamily: "annotation", MinPSNR: 35.0, MaxMeanAbs: 7.0},
	...
	{ID: "unstructured_showcase", Topic: "unstructured", Title: "Unstructured Showcase", Optional: true, Showcase: true, GoBasicSmokeFamily: "unstructured", MinPSNR: 30.0, MaxMeanAbs: 10.0},
	...
	{ID: "axisartist_showcase", Topic: "axisartist", Title: "AxisArtist Showcase", Optional: true, Showcase: true, GoBasicSmokeFamily: "axisartist", MinPSNR: 28.0, MaxMeanAbs: 12.0},
	{ID: "axes_grid1_showcase", Topic: "axes_grid1", Title: "Axes Grid1 Showcase", Optional: true, Showcase: true, GoBasicSmokeFamily: "axes_grid1", MinPSNR: 28.0, MaxMeanAbs: 12.0},
