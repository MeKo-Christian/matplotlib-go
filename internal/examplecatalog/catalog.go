...
var cases = []Case{
	...
	{ID: "contour_styles", Topic: "mesh", Title: "Contour Styles", Optional: true, Description: "Monochrome contour with negative_linestyles dashing; contourf with extend and cycled hatches.", Width: 640, Height: 360, MaxRMSE: 4.6},
