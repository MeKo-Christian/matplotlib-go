...
var cases = []Case{
	...
	{ID: "imshow_clipped", Topic: "image", Title: "Clipped Imshow", FixtureOnly: true, MaxRMSE: 3.7, MaxDiffPixels: 3200, MaxLargestCluster: 1100},
	...
	{ID: "asinh_norm_image", Topic: "colorbar", Title: "AsinhNorm Image", FixtureOnly: true, MaxRMSE: 2.5},
