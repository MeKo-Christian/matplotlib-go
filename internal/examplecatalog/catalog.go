...
var cases = []Case{
	...
	{ID: "patch_showcase", Topic: "patches", Title: "Patch Showcase", Optional: true, SVGGoldenFamily: "hatch_bars", GoBasicSmokeFamily: "patch_hatch", MinPSNR: 35.0, MaxMeanAbs: 6.5, SkiaParityFamily: "patch_hatch"},
