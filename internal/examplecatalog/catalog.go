...
var cases = []Case{
	...
	{ID: "line2d_semantics", Topic: "lines", Title: "Line2D Semantics", FixtureOnly: true, MinPSNR: 34.0, MaxMeanAbs: 8.0, MaxRMSE: 1.0},
	{ID: "line2d_markers", Topic: "lines", Title: "Line2D Markers", FixtureOnly: true, MinPSNR: 30.0, MaxMeanAbs: 10.0, MaxRMSE: 5.0},
	{ID: "path_effects", Topic: "effects", Title: "Path Effects", FixtureOnly: true, MinPSNR: 18.0, MaxMeanAbs: 24.0, MaxRMSE: 3.4, SkiaParityFamily: "effects"},
	{ID: "pattern_gradient_effects", Topic: "effects", Title: "Pattern and Gradient Effects", FixtureOnly: true, MinPSNR: 16.0, MaxMeanAbs: 1.0, MaxRMSE: 4.6, SkiaParityFamily: "effects"},
	...
	{ID: "scatter_marker_types", Topic: "scatter", Title: "Scatter Marker Types", MaxRMSE: 4.3},
	...
	{ID: "fill_between", Topic: "fill", Title: "Fill Between Curves", GoBasicSmokeFamily: "fill", SkiaParityFamily: "fill", MaxRMSE: 2.2},
	{ID: "fill_stacked", Topic: "fill", Title: "Stacked Fill", MaxRMSE: 2.2},
	{ID: "fill_variants", Topic: "fill", Title: "Fill Variants Gallery", Description: "A combined gallery of fill_between, fill_betweenx, stacked fills, and translucent overlapping areas.", WebDemoID: "fills", Showcase: true, Width: 840, Height: 620, MinPSNR: 45.0, MaxMeanAbs: 1.5, MaxRMSE: 3.5},
	...
	{ID: "legend_layout_matrix", Topic: "legend", Title: "Legend Layout Matrix", FixtureOnly: true, MinPSNR: 23.0, MaxMeanAbs: 18.0, MaxRMSE: 5.0},
	...
	{ID: "boxplot_basic", Topic: "boxplot", Title: "Box Plot", Description: "Grouped box plots with whiskers, medians, outliers, and categorical labels.", Optional: true, Showcase: true, MinPSNR: 44.0, MaxMeanAbs: 2.0, MaxRMSE: 5.0},
	{ID: "axes_convenience_helpers", Topic: "axes", Title: "Axes Convenience Helpers", Description: "Precomputed bxp and violin stats, hlines/vlines broadcasting, and post-hoc clabel convenience helpers.", FixtureOnly: true, MinPSNR: 24.0, MaxMeanAbs: 18.0, MaxRMSE: 3.4},
	{ID: "axes_option_breadth_17_75_3", Topic: "axes", Title: "Axes Option Breadth", Description: "Scatter scalar styling, edge-aligned stacked bars with labels, fill-between masks/steps/interpolation, and errorevery sampling.", FixtureOnly: true, MinPSNR: 24.0, MaxMeanAbs: 18.0, MaxRMSE: 4.1},
	...
	{ID: "image_variants_gallery", Topic: "image", Title: "Image Variants Gallery", Description: "Side-by-side interpolation modes, alpha image overlays, MatShow ticks, and spy marker/image modes.", Showcase: true, Width: 1080, Height: 720, MinPSNR: 20.0, MaxMeanAbs: 28.0, MaxRMSE: 2.8},
	...
	{ID: "matshow_basic", Topic: "image", Title: "Matshow", FixtureOnly: true, MinPSNR: 30.0, MaxMeanAbs: 10.0, MaxRMSE: 0.3},
	{ID: "spy_marker", Topic: "image", Title: "Spy Marker Mode", FixtureOnly: true, MinPSNR: 28.0, MaxMeanAbs: 12.0, MaxRMSE: 0.5},
	{ID: "spy_image", Topic: "image", Title: "Spy Image Mode", FixtureOnly: true, MinPSNR: 27.0, MaxMeanAbs: 22.0, MaxRMSE: 0.3},
	...
	{ID: "axes_control_surface", Topic: "axes", Title: "Axes, Scales, and Twins", Optional: true, WebDemoID: "axes", Description: "Minor ticks, top/right axes, aspect controls, log scale, twin axes, and secondary axes.", Showcase: true, GoBasicSmokeFamily: "axes", MinPSNR: 35.0, MaxMeanAbs: 6.5, MaxRMSE: 3.5},
	...
	{ID: "formatter_engineering_labels", Topic: "axes", Title: "Engineering Formatter Labels", FixtureOnly: true, Width: 720, Height: 400, MinPSNR: 35.0, MaxMeanAbs: 6.5, MaxRMSE: 5.0},
	...
	{ID: "artist_metadata", Topic: "artist", Title: "Artist Metadata", FixtureOnly: true, MinPSNR: 40.0, MaxMeanAbs: 4.0, MaxRMSE: 1.2},
	...
	{ID: "stat_variants", Topic: "statistics", Title: "Statistical Views", Optional: true, WebDemoID: "statistics", Description: "Box plots, violin plots, empirical CDFs, and stack plots.", Showcase: true, GoBasicSmokeFamily: "statistics", MinPSNR: 52.5, MaxMeanAbs: 0.30, MaxRMSE: 4.8},
	...
	{ID: "polar_axes", Topic: "polar", Title: "Polar Wave", WebDemoID: "polar", Description: "A filled polar curve with custom radial and angular grid styling.", Showcase: true, SVGGoldenFamily: "clipped_polar", GoBasicSmokeFamily: "polar", MinPSNR: 32.0, MaxMeanAbs: 9.0, SkiaParityFamily: "polar", MaxRMSE: 4.3},
	{ID: "geo_mollweide_axes", Topic: "geo", Title: "Projections and Insets", WebDemoID: "projections", Description: "Mollweide geo projection plus a zoomed inset axes.", Showcase: true, GoBasicSmokeFamily: "geo", MinPSNR: 30.0, MaxMeanAbs: 12.0, MaxRMSE: 5.0},
	{ID: "geo_aitoff_axes", Topic: "geo", Title: "Aitoff Projection", Description: "An Aitoff equal-area projection with longitude wrapping and graticule rendering.", Optional: true, Showcase: true, MinPSNR: 30.0, MaxMeanAbs: 12.0, MaxRMSE: 4.9},
	{ID: "geo_hammer_axes", Topic: "geo", Title: "Hammer Projection", Optional: true, MinPSNR: 30.0, MaxMeanAbs: 12.0, MaxRMSE: 4.9},
	{ID: "geo_lambert_axes", Topic: "geo", Title: "Lambert Projection", Optional: true, MinPSNR: 30.0, MaxMeanAbs: 12.0, MaxRMSE: 0.9},
	{ID: "radar_basic", Topic: "radar", Title: "Radar Projection", Description: "A radar chart using polar projection plumbing with closed polygon series.", Optional: true, Showcase: true, MinPSNR: 45.0, MaxMeanAbs: 2.0, MaxRMSE: 0.7},
