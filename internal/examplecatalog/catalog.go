...
var cases = []Case{
	...
	{ID: "lines_markers_gallery", Topic: "lines", Title: "Line and Marker Style Gallery", Description: "A combined gallery of dash arrays, line joins and caps, a built-in marker grid with open-fill markers, and a multi-series legend.", Showcase: true, Width: 840, Height: 620, MinPSNR: 28.0, MaxMeanAbs: 12.0, MaxRMSE: 14.0},
	...
	{ID: "scatter_gallery", Topic: "scatter", Title: "Advanced Scatter Gallery", Description: "A combined gallery of colormapped scalar mapping, variable marker size, alpha blending of overlapping markers, and multiple marker families.", Showcase: true, Width: 840, Height: 620, MinPSNR: 28.0, MaxMeanAbs: 12.0, MaxRMSE: 14.0},
