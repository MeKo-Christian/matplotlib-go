...
var cases = []Case{
	...
	{ID: "sketch_xkcd", Topic: "effects", Title: "Sketch / xkcd Mode", Description: "A sine curve and a flat reference line under Matplotlib's xkcd sketch mode, exercising the global path.sketch perturbation on spines, ticks, and lines.", FixtureOnly: true, MinPSNR: 62.0, MaxMeanAbs: 0.05, MaxRMSE: 1.0},
	...
	{ID: "mathtext_accents", Topic: "mathtext", Title: "MathText Accents", FixtureOnly: true, SkiaParityFamily: "mathtext", MaxRMSE: 5.0},
	...
	{ID: "text_bbox_styles", Topic: "text", Title: "Text BBox Styles", Description: "Every FancyBboxPatch boxstyle (square, round, round4, circle, ellipse, sawtooth, roundtooth, arrows) applied behind text via the Matplotlib boxstyle spec bridge.", FixtureOnly: true, Width: 640, Height: 360, MaxRMSE: 5.0},
	...
	{ID: "imshow_rgb", Topic: "image", Title: "RGB/RGBA Imshow", FixtureOnly: true, MaxRMSE: 3.0},
	...
	{ID: "matshow_basic", Topic: "image", Title: "Matshow", FixtureOnly: true, MaxRMSE: 2.1},
	{ID: "spy_marker", Topic: "image", Title: "Spy Marker Mode", FixtureOnly: true, MaxRMSE: 0.5},
	{ID: "spy_image", Topic: "image", Title: "Spy Image Mode", FixtureOnly: true, MaxRMSE: 2.7},
	{ID: "colormap_diverging", Topic: "colormap", Title: "Diverging Colormap", FixtureOnly: true, MaxRMSE: 1.7},
	...
	{ID: "path_clipped_transformed", Topic: "axes", Title: "Clipped Transformed Path", FixtureOnly: true, Width: 720, Height: 420, MaxRMSE: 1.9},
	...
	{ID: "figure_labels_composition", Topic: "composition", Title: "Figure Labels", Description: "A multi-axes figure with shared figure title, x label, y label, and legend placement.", WebDemoID: "subplots", Showcase: true, MaxRMSE: 2.0},
	...
	{ID: "annotation_composition", Topic: "annotation", Title: "Annotations", Description: "Text annotations, arrows, anchored labels, and mixed coordinate placement.", Showcase: true, GoBasicSmokeFamily: "annotation", MaxRMSE: 1.7},
	...
	{ID: "stem_horizontal", Topic: "specialty", Title: "Horizontal Stem", Description: "Stem plot with orientation=\"horizontal\": locs along y, heads along x from a vertical baseline.", FixtureOnly: true, MaxMeanAbs: 2.0, MaxRMSE: 4.5},
	{ID: "errorbar_capthick", Topic: "errorbar", Title: "Error Bars (capthick)", Description: "Error bars whose caps use a thicker line than the bars via the capthick kwarg.", FixtureOnly: true, MaxMeanAbs: 2.0, MaxRMSE: 4.2},
	{ID: "scatter_plotnonfinite", Topic: "scatter", Title: "Scatter (plotnonfinite)", Description: "Scatter with plotnonfinite=True: non-finite scalar values ride the colormap bad color while finite points map through viridis.", FixtureOnly: true, MaxMeanAbs: 2.0, MaxRMSE: 3.5},
	{ID: "linecollection_linestyle", Topic: "specialty", Title: "Line Styles", Description: "Per-item LineCollection string linestyles (solid/dashed/dashdot/dotted) via hlines.", FixtureOnly: true, MaxMeanAbs: 2.0, MaxRMSE: 3.5},
	...
	{ID: "skewt_basic", Topic: "skewt", Title: "Skew-T Projection", Description: "A meteorological-style skew-T axes with transformed temperature grid lines.", Optional: true, Showcase: true, MaxRMSE: 5.0},
	...
	{ID: "mplot3d_basic", Topic: "mplot3d", Title: "3D Toolkit Scaffold", Optional: true, GoBasicSmokeFamily: "mplot3d", MaxRMSE: 2.8},
	...
	{ID: "mplot3d_gallery", Topic: "mplot3d", Title: "mplot3d Gallery", Description: "A broad mplot3d gallery covering 3D lines, scatter, surface, wireframe, trisurf, bar3d, voxels, quiver3d, stem3d, and fill-between3d.", Optional: true, WebDemoID: "mplot3d", Width: 1320, Height: 840, Showcase: true, MaxRMSE: 3.7},
	{ID: "mplot3d_plot3d", Topic: "mplot3d", Title: "3D Plot", FixtureOnly: true, Width: 720, Height: 560, MaxRMSE: 1.4},
	{ID: "mplot3d_scatter3d", Topic: "mplot3d", Title: "3D Scatter", FixtureOnly: true, Width: 720, Height: 560, MaxRMSE: 1.7},
	...
	{ID: "mplot3d_trisurf3d", Topic: "mplot3d", Title: "3D Triangulated Surface", FixtureOnly: true, Width: 720, Height: 560, MaxRMSE: 2.2},
	{ID: "mplot3d_bar3d", Topic: "mplot3d", Title: "3D Bars", FixtureOnly: true, Width: 720, Height: 560, MaxRMSE: 3.5},
	{ID: "mplot3d_voxels", Topic: "mplot3d", Title: "3D Voxels", FixtureOnly: true, Width: 720, Height: 560, MaxRMSE: 3.2},
	{ID: "mplot3d_quiver3d", Topic: "mplot3d", Title: "3D Quiver", FixtureOnly: true, Width: 720, Height: 560, MaxRMSE: 3.7},
	{ID: "mplot3d_contour3d", Topic: "mplot3d", Title: "3D Contour", FixtureOnly: true, Width: 720, Height: 560, MaxRMSE: 3.5},
	...
	{ID: "mplot3d_tricontourf3d", Topic: "mplot3d", Title: "3D Triangulated Filled Contour", FixtureOnly: true, Width: 720, Height: 560, MaxRMSE: 2.0},
	{ID: "mplot3d_bar2d_zdir", Topic: "mplot3d", Title: "3D Planar 2D Bars", FixtureOnly: true, Width: 720, Height: 560, MaxRMSE: 1.2},
	{ID: "mplot3d_text3d", Topic: "mplot3d", Title: "3D Text Labels", FixtureOnly: true, Width: 720, Height: 560, MaxRMSE: 2.0},
	{ID: "mplot3d_errorbar3d", Topic: "mplot3d", Title: "3D Error Bars", FixtureOnly: true, Width: 720, Height: 560, MaxRMSE: 3.0},
	{ID: "mplot3d_stem3d", Topic: "mplot3d", Title: "3D Stem", FixtureOnly: true, Width: 720, Height: 560, MaxRMSE: 4.0},
	{ID: "mplot3d_fill_between3d", Topic: "mplot3d", Title: "3D Fill Between", FixtureOnly: true, Width: 720, Height: 560, MaxRMSE: 2.8},
