...
var cases = []Case{
	...
	{ID: "lines_markers_gallery", Topic: "lines", Title: "Line and Marker Style Gallery", Description: "A combined gallery of dash arrays, line joins and caps, a built-in marker grid with open-fill markers, and a multi-series legend.", Showcase: true, Width: 840, Height: 620, MinPSNR: 50.0, MaxMeanAbs: 1.0, MaxRMSE: 6.0},
	...
	{ID: "scatter_gallery", Topic: "scatter", Title: "Advanced Scatter Gallery", Description: "A combined gallery of colormapped scalar mapping, variable marker size, alpha blending of overlapping markers, and multiple marker families.", Showcase: true, Width: 840, Height: 620, MinPSNR: 52.0, MaxMeanAbs: 1.0, MaxRMSE: 4.0},
	...
	{ID: "bar_variants", Topic: "bar", Title: "Bar Variants Gallery", Description: "A combined gallery of vertical bars with tick labels, horizontal bars, grouped bars, and stacked bars with bar labels.", Showcase: true, Width: 840, Height: 620, MinPSNR: 45.0, MaxMeanAbs: 1.5, MaxRMSE: 8.0},
	...
	{ID: "fill_variants", Topic: "fill", Title: "Fill Variants Gallery", Description: "A combined gallery of fill_between, fill_betweenx, stacked fills, and translucent overlapping areas.", Showcase: true, Width: 840, Height: 620, MinPSNR: 45.0, MaxMeanAbs: 1.5, MaxRMSE: 8.0},
	...
	{ID: "histogram_variants", Topic: "histogram", Title: "Histogram Variants Gallery", Description: "A combined gallery of count, density, cumulative, and overlapping probability histograms over deterministic samples.", Showcase: true, Width: 840, Height: 620, MinPSNR: 45.0, MaxMeanAbs: 1.5, MaxRMSE: 8.0},
	...
	{ID: "image_heatmap", Topic: "image", Title: "Heatmap Image", Description: "A gridded image plot with a colorbar and axis labels for matrix-style data.", Showcase: true, SVGGoldenFamily: "image", GoBasicSmokeFamily: "image", SkiaParityFamily: "image"},
	...
	{ID: "colorbar_variants_gallery", Topic: "colorbar", Title: "Colorbar Variants Gallery", Description: "LogNorm, TwoSlopeNorm, BoundaryNorm draw edges, and under/over extension colorbars with labels.", Showcase: true, Width: 1040, Height: 720, MinPSNR: 20.0, MaxMeanAbs: 26.0, MaxRMSE: 42.0},
	...
	{ID: "mplot3d_gallery", Topic: "mplot3d", Title: "mplot3d Gallery", Description: "A broad mplot3d gallery covering 3D lines, scatter, surface, wireframe, trisurf, bar3d, voxels, quiver3d, stem3d, and fill-between3d.", Optional: true, Width: 1320, Height: 840, Showcase: true, MinPSNR: 22.0, MaxMeanAbs: 24.0, MaxRMSE: 42.0},
	...
	{ID: "mplot3d_text3d", Topic: "mplot3d", Title: "3D Text Labels", FixtureOnly: true, Width: 720, Height: 560, MinPSNR: 30.0, MaxMeanAbs: 10.0, MaxRMSE: 18.0},
	...
	{ID: "triangulation_gallery", Topic: "unstructured", Title: "Triangulation Gallery", Description: "A focused triangulation gallery covering triplot, tripcolor, tricontour, tricontourf, and masked pcolormesh behavior.", Optional: true, Width: 1320, Height: 760, Showcase: true, MinPSNR: 18.0, MaxMeanAbs: 30.0, MaxRMSE: 50.0},
