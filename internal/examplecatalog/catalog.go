...
var cases = []Case{
	...
	{ID: "joins_caps", Topic: "lines", Title: "Line Joins and Caps", MaxRMSE: 0.05},
	{ID: "dashes", Topic: "lines", Title: "Dash Patterns", Description: "Multiple line styles showing dash arrays, cap styles, and legend labeling.", Showcase: true, MaxRMSE: 0.05},
	...
	{ID: "path_effects", Topic: "effects", Title: "Path Effects", FixtureOnly: true, MaxRMSE: 0.0788, SkiaParityFamily: "effects"},
	...
	{ID: "scatter_basic", Topic: "scatter", Title: "Basic Scatter", Description: "A compact scatter plot with variable marker size, color, alpha, and axes labels.", Showcase: true, GoBasicSmokeFamily: "scatter", SkiaParityFamily: "scatter", MaxRMSE: 0.05},
	{ID: "scatter_marker_types", Topic: "scatter", Title: "Scatter Marker Types", MaxRMSE: 2.8},
	{ID: "scatter_advanced", Topic: "scatter", Title: "Advanced Scatter", MaxRMSE: 0.05},
	...
	{ID: "bar_basic_frame", Topic: "bar", Title: "Bar Frame", MaxRMSE: 0.05},
	{ID: "bar_basic_ticks", Topic: "bar", Title: "Bar Ticks", MaxRMSE: 0.05},
	{ID: "bar_basic_tick_labels", Topic: "bar", Title: "Bar Tick Labels", MaxRMSE: 0.05},
	{ID: "bar_basic_title", Topic: "bar", Title: "Bar Title", MaxRMSE: 0.05},
	{ID: "bar_basic", Topic: "bar", Title: "Basic Bars", Description: "A categorical bar chart with tick labels, title text, and framed axes.", Showcase: true, SVGGoldenFamily: "bar", GoBasicSmokeFamily: "bar", SkiaParityFamily: "bar", MaxRMSE: 0.05},
	{ID: "bar_horizontal", Topic: "bar", Title: "Horizontal Bars", MaxRMSE: 0.05},
	...
	{ID: "bar_yerr", Topic: "bar", Title: "Bars with Error Bars", MaxMeanAbs: 0.01, MaxRMSE: 0.05},
	{ID: "fill_basic", Topic: "fill", Title: "Fill to Baseline", Description: "A filled region under a smooth curve, useful for area-chart and alpha blending checks.", Showcase: true, MaxRMSE: 0.05},
	{ID: "fill_between", Topic: "fill", Title: "Fill Between Curves", GoBasicSmokeFamily: "fill", SkiaParityFamily: "fill", MaxRMSE: 0.05},
	{ID: "fill_stacked", Topic: "fill", Title: "Stacked Fill", MaxRMSE: 0.05},
	{ID: "stackplot_streamgraph", Topic: "fill", Title: "Streamgraph (weighted_wiggle)", Description: "A stackplot using the weighted_wiggle baseline (streamgraph layout) with default property-cycle colors.", Optional: true, MaxMeanAbs: 0.01, MaxRMSE: 0.05},
	{ID: "fill_variants", Topic: "fill", Title: "Fill Variants Gallery", Description: "A combined gallery of fill_between, fill_betweenx, stacked fills, and translucent overlapping areas.", WebDemoID: "fills", Showcase: true, Width: 840, Height: 620, MaxMeanAbs: 0.01, MaxRMSE: 0.05},
	...
	{ID: "hist_strategies", Topic: "histogram", Title: "Histogram Strategies", MaxRMSE: 0.163},
	{ID: "histogram_variants", Topic: "histogram", Title: "Histogram Variants Gallery", Description: "A combined gallery of count, density, cumulative, and overlapping probability histograms over deterministic samples.", WebDemoID: "histogram", Showcase: true, Width: 840, Height: 620, MaxMeanAbs: 0.01, MaxRMSE: 0.283},
	...
	{ID: "axes_log_plot_wrappers", Topic: "axes", Title: "Log Plot Wrappers", Description: "Focused visual coverage for SemilogX, SemilogY, and LogLog convenience plotting.", FixtureOnly: true, Width: 960, Height: 360, MaxMeanAbs: 0.01, MaxRMSE: 0.0562},
	...
	{ID: "mathtext_gallery", Topic: "mathtext", Title: "MathText Gallery", Description: "Fractions, roots, operators, fences, matrices, and inline MathText labels in one browsable figure.", Showcase: true, Width: 900, Height: 560, MaxRMSE: 0.05, MaxDiffPixels: 4, MaxLargestCluster: 4},
	...
	{ID: "image_heatmap", Topic: "image", Title: "Heatmap Image", Description: "A gridded image plot with a colorbar and axis labels for matrix-style data.", WebDemoID: "heatmap", Showcase: true, SVGGoldenFamily: "image", GoBasicSmokeFamily: "image", SkiaParityFamily: "image", MaxRMSE: 0.05, MaxDiffPixels: 2, MaxLargestCluster: 2},
	{ID: "image_variants_gallery", Topic: "image", Title: "Image Variants Gallery", Description: "Side-by-side interpolation modes, alpha image overlays, MatShow ticks, and spy marker/image modes.", Showcase: true, Width: 1080, Height: 720, MaxRMSE: 1.55},
	{ID: "imshow_clipped", Topic: "image", Title: "Clipped Imshow", FixtureOnly: true, MaxRMSE: 0.05, MaxDiffPixels: 1, MaxLargestCluster: 1},
	...
	{ID: "matshow_basic", Topic: "image", Title: "Matshow", FixtureOnly: true, MaxRMSE: 0.05, MaxDiffPixels: 4, MaxLargestCluster: 4},
	{ID: "spy_marker", Topic: "image", Title: "Spy Marker Mode", FixtureOnly: true, MaxRMSE: 0.5},
	{ID: "spy_image", Topic: "image", Title: "Spy Image Mode", FixtureOnly: true, MaxRMSE: 0.05},
	{ID: "colormap_diverging", Topic: "colormap", Title: "Diverging Colormap", FixtureOnly: true, MaxRMSE: 0.1, MaxDiffPixels: 2, MaxLargestCluster: 2},
	{ID: "colormap_qualitative", Topic: "colormap", Title: "Qualitative Colormap", FixtureOnly: true, MaxRMSE: 0.05},
	...
	{ID: "path_clipped_transformed", Topic: "axes", Title: "Clipped Transformed Path", FixtureOnly: true, Width: 720, Height: 420, MaxRMSE: 0.05},
	{ID: "layout_bbox_helpers", Topic: "axes", Title: "Layout BBox Helpers", FixtureOnly: true, Width: 720, Height: 420, MaxRMSE: 0.05},
	...
	{ID: "formatter_fixed_null_labels", Topic: "axes", Title: "Fixed and Null Formatter Labels", FixtureOnly: true, MaxRMSE: 0.0537},
	{ID: "formatter_log_mathtext_labels", Topic: "axes", Title: "Log MathText Formatter Labels", FixtureOnly: true, MaxMeanAbs: 0.01, MaxRMSE: 0.05},
	{ID: "formatter_percent_labels", Topic: "axes", Title: "Percent Formatter Labels", FixtureOnly: true, MaxRMSE: 0.05},
	...
	{ID: "locator_fixed_index_labels", Topic: "axes", Title: "Fixed and Index Locator Labels", FixtureOnly: true, Width: 720, Height: 420, MaxMeanAbs: 0.01, MaxRMSE: 0.05},
	{ID: "locator_linear_labels", Topic: "axes", Title: "Linear Locator Labels", FixtureOnly: true, Width: 720, Height: 540, MaxMeanAbs: 0.01, MaxRMSE: 0.05},
	...
	{ID: "locator_maxn_edge_labels", Topic: "axes", Title: "MaxN Locator Edge Labels", FixtureOnly: true, Width: 720, Height: 540, MaxMeanAbs: 0.01, MaxRMSE: 0.05},
	...
	{ID: "scale_function_defaults", Topic: "axes", Title: "Function Scale Defaults", FixtureOnly: true, Width: 720, Height: 480, MaxMeanAbs: 0.01, MaxRMSE: 0.055},
	{ID: "scale_logit_ticks", Topic: "axes", Title: "Logit Scale Ticks", FixtureOnly: true, Width: 720, Height: 400, MaxMeanAbs: 0.01, MaxRMSE: 0.05},
	{ID: "scale_symlog_ticks", Topic: "axes", Title: "Symlog Scale Ticks", FixtureOnly: true, Width: 720, Height: 400, MaxMeanAbs: 0.01, MaxRMSE: 0.05},
	...
	{ID: "gridspec_composition", Topic: "composition", Title: "Figure Composition", WebDemoID: "composition", Description: "GridSpec spans, figure-level labels, figure legends, anchored text, and colorbars.", Showcase: true, GoBasicSmokeFamily: "layout", MaxRMSE: 0.05},
	...
	{ID: "spectrum_variants", Topic: "signal", Title: "Spectrum Variants", FixtureOnly: true, GoBasicSmokeFamily: "signal", MaxMeanAbs: 0.01, MaxRMSE: 0.0612},
	{ID: "psd_welch", Topic: "signal", Title: "Welch Power Spectral Density", Description: "Direct PSD coverage with overlapping Hann-windowed, mean-detrended segments and zero padding.", FixtureOnly: true, Width: 640, Height: 360, MaxMeanAbs: 0.01, MaxRMSE: 0.0775},
	{ID: "specgram_psd", Topic: "signal", Title: "PSD Spectrogram", Description: "Direct Specgram coverage for an overlapping-window chirp rendered in decibels.", FixtureOnly: true, Width: 640, Height: 360, MaxMeanAbs: 0.01, MaxRMSE: 0.05, MaxDiffPixels: 8, MaxLargestCluster: 4},
	{ID: "cohere_welch", Topic: "signal", Title: "Welch Coherence", Description: "Direct Cohere coverage for partially shared deterministic signals.", FixtureOnly: true, Width: 640, Height: 360, MaxMeanAbs: 0.01, MaxRMSE: 0.05},
	{ID: "csd_welch", Topic: "signal", Title: "Welch Cross-Spectral Density", Description: "Direct CSD coverage with overlapping Hann-windowed, mean-detrended segments and zero padding.", FixtureOnly: true, Width: 640, Height: 360, MaxMeanAbs: 0.01, MaxRMSE: 0.0775},
	{ID: "stat_variants", Topic: "statistics", Title: "Statistical Views", Optional: true, WebDemoID: "statistics", Description: "Box plots, violin plots, empirical CDFs, and stack plots.", Showcase: true, GoBasicSmokeFamily: "statistics", MaxMeanAbs: 0.01, MaxRMSE: 0.0838, MaxDiffPixels: 99, MaxLargestCluster: 68},
	...
	{ID: "errorbar_capthick", Topic: "errorbar", Title: "Error Bars (capthick)", Description: "Error bars whose caps use a thicker line than the bars via the capthick kwarg.", FixtureOnly: true, MaxMeanAbs: 0.01, MaxRMSE: 0.05},
	...
	{ID: "linecollection_linestyle", Topic: "specialty", Title: "Line Styles", Description: "Per-item LineCollection string linestyles (solid/dashed/dashdot/dotted) via hlines.", FixtureOnly: true, MaxMeanAbs: 0.01, MaxRMSE: 0.05},
	...
	{ID: "date_concise_intraday_labels", Topic: "units", Title: "Concise Intraday Date Labels", FixtureOnly: true, Width: 720, Height: 360, MaxMeanAbs: 0.01, MaxRMSE: 0.05},
	{ID: "date_month_year_labels", Topic: "units", Title: "Month and Year Date Labels", FixtureOnly: true, Width: 720, Height: 360, MaxMeanAbs: 0.01, MaxRMSE: 0.05},
	...
	{ID: "units_custom_converter", Topic: "units", Title: "Custom Unit Converter", Optional: true, MaxMeanAbs: 0.01, MaxRMSE: 0.05},
	...
	{ID: "unstructured_showcase", Topic: "unstructured", Title: "Unstructured Showcase", Description: "Triangulated and irregular data views covering triplot, tripcolor, and contour variants.", Optional: true, Showcase: true, GoBasicSmokeFamily: "unstructured", MaxRMSE: 1.3, MaxDiffPixels: 2000, MaxLargestCluster: 210},
	...
	{ID: "animation_gallery", Topic: "animation", Title: "Animation Playback", Description: "FuncAnimation and ArtistAnimation setup with repeat, repeat-delay, blit, and explicit unsupported writer behavior.", Optional: true, WebDemoID: "animation", Width: 1000, Height: 560, Showcase: true, GoBasicSmokeFamily: "animation", MaxRMSE: 0.05},
	{ID: "animation_line_frame", Topic: "animation", Title: "Animated Line Frame", Description: "Deterministic frame-N capture of a traveling-wave FuncAnimation line plot.", FixtureOnly: true, Width: 640, Height: 360, MaxMeanAbs: 0.0112, MaxRMSE: 0.117},
	...
	{ID: "animation_imshow_frame", Topic: "animation", Title: "Animated Heatmap Frame", Description: "Deterministic frame-N capture of a ripple imshow (heatmap) animation.", FixtureOnly: true, Width: 640, Height: 360, MaxMeanAbs: 0.01, MaxRMSE: 0.05},
	{ID: "animation_subplots_frame", Topic: "animation", Title: "Animated Subplots Frame", Description: "Deterministic frame-N capture of a two-panel line + heatmap subplot composition animation.", FixtureOnly: true, Width: 800, Height: 360, MaxMeanAbs: 0.01, MaxRMSE: 0.0925, MaxDiffPixels: 8, MaxLargestCluster: 4},
	...
	{ID: "asinh_norm_image", Topic: "colorbar", Title: "AsinhNorm Image", FixtureOnly: true, MaxRMSE: 1.85, MaxDiffPixels: 650, MaxLargestCluster: 410},
	...
	{ID: "lognorm_imshow", Topic: "colorbar", Title: "LogNorm Imshow", FixtureOnly: true, MaxRMSE: 0.65, MaxDiffPixels: 650, MaxLargestCluster: 520},
	{ID: "twoslope_norm_image", Topic: "colorbar", Title: "TwoSlopeNorm Image", FixtureOnly: true, MaxRMSE: 0.75},
