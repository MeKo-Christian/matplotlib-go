...
var cases = []Case{
	...
	{ID: "pattern_gradient_effects", Topic: "effects", Title: "Pattern and Gradient Effects", FixtureOnly: true, MinPSNR: 16.0, MaxMeanAbs: 28.0, MaxRMSE: 48.0, SkiaParityFamily: "effects"},
