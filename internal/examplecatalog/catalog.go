...
var cases = []Case{
	...
	{ID: "path_effects", Topic: "effects", Title: "Path Effects", FixtureOnly: true, MinPSNR: 18.0, MaxMeanAbs: 24.0, MaxRMSE: 42.0, SkiaParityFamily: "effects"},
	{ID: "pattern_gradient_effects", Topic: "effects", Title: "Pattern and Gradient Effects", FixtureOnly: true, MinPSNR: 16.0, MaxMeanAbs: 1.0, MaxRMSE: 48.0, SkiaParityFamily: "effects"},
	{ID: "scatter_basic", Topic: "scatter", Title: "Basic Scatter", Description: "A compact scatter plot with variable marker size, color, alpha, and axes labels.", Showcase: true, GoBasicSmokeFamily: "scatter", SkiaParityFamily: "scatter"},
	...
	{ID: "bar_basic", Topic: "bar", Title: "Basic Bars", Description: "A categorical bar chart with tick labels, title text, and framed axes.", Showcase: true, SVGGoldenFamily: "bar", GoBasicSmokeFamily: "bar", SkiaParityFamily: "bar"},
	{ID: "bar_horizontal", Topic: "bar", Title: "Horizontal Bars"},
	{ID: "bar_grouped", Topic: "bar", Title: "Grouped Bars"},
	{ID: "bar_variants", Topic: "bar", Title: "Bar Variants Gallery", Description: "A combined gallery of vertical bars with tick labels, horizontal bars, grouped bars, and stacked bars with bar labels.", WebDemoID: "bars", Showcase: true, Width: 840, Height: 620, MinPSNR: 45.0, MaxMeanAbs: 1.5, MaxRMSE: 8.0},
	...
	{ID: "fill_between", Topic: "fill", Title: "Fill Between Curves", GoBasicSmokeFamily: "fill", SkiaParityFamily: "fill"},
	{ID: "fill_stacked", Topic: "fill", Title: "Stacked Fill"},
	{ID: "fill_variants", Topic: "fill", Title: "Fill Variants Gallery", Description: "A combined gallery of fill_between, fill_betweenx, stacked fills, and translucent overlapping areas.", WebDemoID: "fills", Showcase: true, Width: 840, Height: 620, MinPSNR: 45.0, MaxMeanAbs: 1.5, MaxRMSE: 8.0},
	{ID: "errorbar_basic", Topic: "errorbar", Title: "Error Bars", Description: "Symmetric and asymmetric error bars with caps, marker styling, and legend output.", WebDemoID: "errorbars", Showcase: true, SVGGoldenFamily: "errorbar", GoBasicSmokeFamily: "errorbar", SkiaParityFamily: "errorbar"},
	...
	{ID: "legend_layout_matrix", Topic: "legend", Title: "Legend Layout Matrix", FixtureOnly: true, MinPSNR: 23.0, MaxMeanAbs: 18.0, MaxRMSE: 10.0},
	...
	{ID: "histogram_variants", Topic: "histogram", Title: "Histogram Variants Gallery", Description: "A combined gallery of count, density, cumulative, and overlapping probability histograms over deterministic samples.", WebDemoID: "histogram", Showcase: true, Width: 840, Height: 620, MinPSNR: 45.0, MaxMeanAbs: 1.5, MaxRMSE: 8.0},
	...
	{ID: "axes_option_breadth_17_75_3", Topic: "axes", Title: "Axes Option Breadth", Description: "Scatter scalar styling, edge-aligned stacked bars with labels, fill-between masks/steps/interpolation, and errorevery sampling.", FixtureOnly: true, MinPSNR: 24.0, MaxMeanAbs: 18.0, MaxRMSE: 36.0},
	...
	{ID: "mathtext_fractions", Topic: "mathtext", Title: "MathText Fractions", FixtureOnly: true, SkiaParityFamily: "mathtext"},
	{ID: "mathtext_integrals", Topic: "mathtext", Title: "MathText Operators", FixtureOnly: true, SkiaParityFamily: "mathtext"},
	...
	{ID: "colormap_families_gallery", Topic: "colormap", Title: "Colormap Family Gallery", Description: "Sequential, reversed, perceptual, diverging, qualitative, and cyclic colormap strips in one browsable figure.", Showcase: true, Width: 900, Height: 520, MinPSNR: 28.0, MaxMeanAbs: 18.0, MaxRMSE: 32.0},
	{ID: "named_colors", Topic: "color", Title: "Named Colors", FixtureOnly: true, MinPSNR: 35.0, MaxMeanAbs: 8.0},
	{ID: "named_colors_gallery", Topic: "color", Title: "Named Color Swatches", Description: "CSS4 names, Tableau tab colors, xkcd names, shorthand colors, grayscale strings, hex values, and RGBA tuples.", Showcase: true, Width: 900, Height: 520, MinPSNR: 35.0, MaxMeanAbs: 8.0},
	...
	// W3.9 ratchet: regenerated golden-vs-reference RMSE is 5.80. The
	...
	{ID: "figure_labels_composition", Topic: "composition", Title: "Figure Labels", Description: "A multi-axes figure with shared figure title, x label, y label, and legend placement.", WebDemoID: "subplots", Showcase: true, MinPSNR: 32.0, MaxMeanAbs: 9.0},
	...
	{ID: "colorbar_variants_gallery", Topic: "colorbar", Title: "Colorbar Variants Gallery", Description: "LogNorm, TwoSlopeNorm, BoundaryNorm draw edges, and under/over extension colorbars with labels.", WebDemoID: "colorbars", Showcase: true, Width: 1040, Height: 720, MinPSNR: 20.0, MaxMeanAbs: 26.0, MaxRMSE: 42.0},
	...
	// W3.9 ratchet: regenerated golden-vs-reference RMSE is 6.67. Tick
	// sequence and formatter selection now match; the visible tail is text-edge
	// rasterization on dense intraday labels.
	{ID: "date_concise_intraday_labels", Topic: "units", Title: "Concise Intraday Date Labels", FixtureOnly: true, Width: 720, Height: 360, MinPSNR: 57.0, MaxMeanAbs: 0.20, MaxRMSE: 7.0},
	...
	{ID: "units_categories", Topic: "units", Title: "Category Units", Optional: true, MinPSNR: 57.0, MaxMeanAbs: 0.15, MaxRMSE: 5.0},
	...
	{ID: "polar_axes", Topic: "polar", Title: "Polar Wave", WebDemoID: "polar", Description: "A filled polar curve with custom radial and angular grid styling.", Showcase: true, SVGGoldenFamily: "clipped_polar", GoBasicSmokeFamily: "polar", MinPSNR: 32.0, MaxMeanAbs: 9.0, SkiaParityFamily: "polar"},
	...
	{ID: "mplot3d_gallery", Topic: "mplot3d", Title: "mplot3d Gallery", Description: "A broad mplot3d gallery covering 3D lines, scatter, surface, wireframe, trisurf, bar3d, voxels, quiver3d, stem3d, and fill-between3d.", Optional: true, WebDemoID: "mplot3d", Width: 1320, Height: 840, Showcase: true, MinPSNR: 22.0, MaxMeanAbs: 24.0, MaxRMSE: 42.0},
	...
	{ID: "mplot3d_contour3d", Topic: "mplot3d", Title: "3D Contour", FixtureOnly: true, Width: 720, Height: 560, MinPSNR: 30.0, MaxMeanAbs: 12.0, MaxRMSE: 18.0},
	{ID: "mplot3d_contourf3d", Topic: "mplot3d", Title: "3D Filled Contour", FixtureOnly: true, Width: 720, Height: 560, MinPSNR: 30.0, MaxMeanAbs: 12.0, MaxRMSE: 18.0},
	{ID: "mplot3d_tricontour3d", Topic: "mplot3d", Title: "3D Triangulated Contour", FixtureOnly: true, Width: 720, Height: 560, MinPSNR: 30.0, MaxMeanAbs: 12.0, MaxRMSE: 18.0},
	{ID: "mplot3d_tricontourf3d", Topic: "mplot3d", Title: "3D Triangulated Filled Contour", FixtureOnly: true, Width: 720, Height: 560, MinPSNR: 30.0, MaxMeanAbs: 12.0, MaxRMSE: 18.0},
	{ID: "mplot3d_bar2d_zdir", Topic: "mplot3d", Title: "3D Planar 2D Bars", FixtureOnly: true, Width: 720, Height: 560, MinPSNR: 30.0, MaxMeanAbs: 8.0, MaxRMSE: 18.0},
	...
	{ID: "widgets_gallery", Topic: "widgets", Title: "Widgets and Selectors", Description: "Buttons, sliders, range sliders, text boxes, check and radio buttons, selectors, cursor, and multi-cursor helpers.", Optional: true, Width: 1100, Height: 760, Showcase: true, GoBasicSmokeFamily: "widgets", MinPSNR: 10.0, MaxMeanAbs: 95.0, MaxRMSE: 120.0},
	{ID: "animation_gallery", Topic: "animation", Title: "Animation Playback", Description: "FuncAnimation and ArtistAnimation setup with repeat, repeat-delay, blit, and explicit unsupported writer behavior.", Optional: true, WebDemoID: "animation", Width: 1000, Height: 560, Showcase: true, GoBasicSmokeFamily: "animation", MinPSNR: 10.0, MaxMeanAbs: 95.0, MaxRMSE: 120.0},
	...
	{ID: "animation_imshow_frame", Topic: "animation", Title: "Animated Heatmap Frame", Description: "Deterministic frame-N capture of a ripple imshow (heatmap) animation.", FixtureOnly: true, Width: 640, Height: 360, MinPSNR: 45.0, MaxMeanAbs: 1.5, MaxRMSE: 6.0},
	{ID: "animation_subplots_frame", Topic: "animation", Title: "Animated Subplots Frame", Description: "Deterministic frame-N capture of a two-panel line + heatmap subplot composition animation.", FixtureOnly: true, Width: 800, Height: 360, MinPSNR: 45.0, MaxMeanAbs: 1.5, MaxRMSE: 6.0},
	{ID: "axisartist_showcase", Topic: "axisartist", Title: "AxisArtist Showcase", Description: "Floating and axis-artist style axes with custom spine placement and labels.", Optional: true, WebDemoID: "axisartist", Showcase: true, GoBasicSmokeFamily: "axisartist", MinPSNR: 28.0, MaxMeanAbs: 12.0},
	{ID: "axes_grid1_showcase", Topic: "axes_grid1", Title: "Axes Grid1 Showcase", Description: "Axes divider, image-grid, inset, and anchored layout helpers in one composition.", Optional: true, WebDemoID: "axes_grid1", Showcase: true, GoBasicSmokeFamily: "axes_grid1", MinPSNR: 28.0, MaxMeanAbs: 12.0},
	...
	{ID: "asinh_norm_image", Topic: "colorbar", Title: "AsinhNorm Image", FixtureOnly: true, MinPSNR: 28.0, MaxMeanAbs: 16.0},
	...
	{ID: "colorbar_boundary_values", Topic: "colorbar", Title: "Boundary Colorbar Values", FixtureOnly: true, MinPSNR: 28.0, MaxMeanAbs: 16.0},
	...
	{ID: "large_scatter", Topic: "raster", Title: "Large Scatter Batch", FixtureOnly: true, NativeBackend: "agg", NativeCapabilities: []string{"pathcollectionbatch"}, MinPSNR: 55.0, MaxMeanAbs: 0.5, MaxRMSE: 6.0},
	{ID: "mixed_collection", Topic: "raster", Title: "Mixed Path Collection", FixtureOnly: true, NativeBackend: "agg", NativeCapabilities: []string{"pathcollectionbatch"}, SVGGoldenFamily: "collection", GoBasicSmokeFamily: "collection", MinPSNR: 55.0, MaxMeanAbs: 0.5, MaxRMSE: 7.0},
	{ID: "mixed_raster_vector", Topic: "raster", Title: "Mixed Raster Vector Output", Description: "A polar mixed-output example with rasterized dense scatter points and vector-preserved line, text, axes, legend, SVG, and PDF artifacts.", Showcase: true, Width: 640, Height: 640, SVGGoldenFamily: "mixed_raster", MinPSNR: 32.0, MaxMeanAbs: 9.0, MaxRMSE: 18.0},
	{ID: "quad_mesh", Topic: "raster", Title: "Quad Mesh Batch", FixtureOnly: true, NativeBackend: "agg", NativeCapabilities: []string{"quadmeshbatch"}, MinPSNR: 48.0, MaxMeanAbs: 1.0, MaxRMSE: 6.0},
	...
	{ID: "clip_path_batch", Topic: "raster", Title: "Clip Path Batch", FixtureOnly: true, NativeBackend: "agg", NativeCapabilities: []string{"pathclip", "quadmeshbatch"}, MinPSNR: 45.0, MaxMeanAbs: 1.0, MaxRMSE: 8.0},
}
