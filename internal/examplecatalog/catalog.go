...
var cases = []Case{
	...
	{ID: "mathtext_gallery", Topic: "mathtext", Title: "MathText Gallery", Description: "Fractions, roots, operators, fences, matrices, and inline MathText labels in one browsable figure.", Showcase: true, Width: 900, Height: 560, MaxRMSE: 2.6, MaxDiffPixels: 80, MaxLargestCluster: 80},
	...
	{ID: "image_heatmap", Topic: "image", Title: "Heatmap Image", Description: "A gridded image plot with a colorbar and axis labels for matrix-style data.", WebDemoID: "heatmap", Showcase: true, SVGGoldenFamily: "image", GoBasicSmokeFamily: "image", SkiaParityFamily: "image", MaxRMSE: 0.07, MaxDiffPixels: 2, MaxLargestCluster: 2},
	...
	{ID: "imshow_clipped", Topic: "image", Title: "Clipped Imshow", FixtureOnly: true, MaxRMSE: 0.1, MaxDiffPixels: 1, MaxLargestCluster: 1},
	...
	{ID: "specgram_psd", Topic: "signal", Title: "PSD Spectrogram", Description: "Direct Specgram coverage for an overlapping-window chirp rendered in decibels.", FixtureOnly: true, Width: 640, Height: 360, MaxMeanAbs: 0.035, MaxRMSE: 1.05, MaxDiffPixels: 400, MaxLargestCluster: 400},
	...
	{ID: "asinh_norm_image", Topic: "colorbar", Title: "AsinhNorm Image", FixtureOnly: true, MaxRMSE: 1.85, MaxDiffPixels: 650, MaxLargestCluster: 420},
	...
	{ID: "lognorm_imshow", Topic: "colorbar", Title: "LogNorm Imshow", FixtureOnly: true, MaxRMSE: 0.65, MaxDiffPixels: 650, MaxLargestCluster: 420},
