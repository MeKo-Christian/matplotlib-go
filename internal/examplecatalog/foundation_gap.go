...
var foundationAPIGaps = []FoundationAPIGap{
	...
	},
	{
		...
		CurrentEquivalent: "Go has common patch shapes, hatch routing, FancyBboxPatch with the upstream " +
			...
			"DPI-correct Matplotlib-style FancyArrowPatch endpoint shrinking, explicit ConnectionPatch shrink conversion, FancyArrowPatch / ConnectionPatch round cap/join defaults, FancyArrowPatch mutation-aspect arrow transmutation, ArrowStyle Simple / Fancy / Wedge quadratic-connection geometry, ArrowStyle Wedge shrink-factor behavior, ArrowStyle curve line shortening and bracket scale overrides, ArrowStyle BarAB zero-length bracket defaults, ConnectionStyle Arc3 zero-rad quadratic paths, Arc defaults and rounded arm geometry, ConnectionStyle Bar angle projection, ConnectionPatch, and several extra patch classes.",
