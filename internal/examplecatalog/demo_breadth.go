...
// DemoBreadthGap records one gap where parity fixtures exist, but
...
var demoBreadthGaps = []DemoBreadthGap{
	{
		...
		RecommendedDemo:              "Keep lines_markers_gallery as the user-facing breadth example and track residual Line2D property/API edge cases separately.",
	...
	},
	{
		...
		RecommendedDemo:              "Keep scatter_gallery as the user-facing breadth example and track dense-collection/API stress behavior separately.",
	...
	},
	{
		...
		RecommendedDemo:              "Keep bar_variants as the user-facing breadth example and track residual bar option/API breadth separately.",
	...
	},
	{
		...
		RecommendedDemo:              "Keep fill_variants as the user-facing breadth example and track residual fill option/API breadth separately.",
	...
	},
	{
		...
		RecommendedDemo:              "Keep histogram_variants as the user-facing breadth example and track residual bin-strategy and weighted-hist2d API breadth separately.",
	...
	},
	{
		...
		RecommendedDemo:              "Keep colormap_families_gallery as the user-facing breadth example and track residual resampled-map API breadth separately.",
	...
	},
	{
		...
		RecommendedDemo:              "Keep image_variants_gallery as the user-facing breadth example and track residual transformed-image sampling edge cases separately.",
	...
	},
	{
		...
		RecommendedDemo:              "Keep colorbar_variants_gallery as the user-facing breadth example and track residual formatter, placement, and mutable scalar-map behavior separately.",
	...
	},
	{
		...
		RecommendedDemo:              "Keep mathtext_gallery as the user-facing breadth example and track residual MathText pixel/API edge cases separately.",
	...
	},
	{
		...
		RecommendedDemo:              "Keep ticks_scales_formatters_gallery as the user-facing breadth example and split residual locator/formatter API edge cases out separately.",
	...
	},
	{
		...
		RecommendedDemo:              "Keep text_layout_gallery as the user-facing breadth example and track residual text metric/API edge cases separately.",
	...
	},
	{
		...
		RecommendedDemo:              "Keep annotation_legend_offsetbox_gallery as the user-facing breadth example and track residual interactive/API edge cases separately.",
	...
	},
	{
		...
		RecommendedDemo:              "Keep mplot3d_gallery as the user-facing breadth example and track residual 3D contour/text/errorbar projection edge cases separately.",
...
// DemoBreadthGaps returns the demo-breadth audit rows.
...
// LookupDemoBreadthGap finds a demo-breadth gap by stable ID.
