...
var parityFixValidationTargets = []ParityFixValidationTarget{
	...
	{CaseID: "mplot3d_contour3d", ClusterIDs: []string{ValidationClusterProjection3D}},
	{CaseID: "mplot3d_contourf3d", ClusterIDs: []string{ValidationClusterProjection3D}},
	{CaseID: "mplot3d_tricontour3d", ClusterIDs: []string{ValidationClusterProjection3D}},
	{CaseID: "mplot3d_tricontourf3d", ClusterIDs: []string{ValidationClusterProjection3D}},
