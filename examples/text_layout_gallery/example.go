...
func addRotatedSamples(ax *core.Axes) {
	...
	ax.Text(4.50, 3.18, "anchor", core.TextOptions{
		...
		FontSize:     12,
		BBox:         textBox(12, 0.22, render.Color{R: 0.88, G: 0.94, B: 1.00, A: 0.78}, render.Color{R: 0.20, G: 0.38, B: 0.68, A: 1}),
	})
}
...
func addMultilineSamples(ax *core.Axes) {
	...
	ax.Text(0.75, 1.75, "multi-line\nleft aligned\ntext", core.TextOptions{
		...
		Linespacing:    1.3,
		FontSize:       11,
		BBox:           textBox(11, 0.28, render.Color{R: 0.94, G: 0.97, B: 0.92, A: 0.86}, render.Color{R: 0.24, G: 0.50, B: 0.20, A: 1}),
	})
	ax.Text(2.55, 1.65, "right\naligned\nblock", core.TextOptions{
		...
		Linespacing:    1.15,
		FontSize:       11,
		BBox:           textBox(11, 0.28, render.Color{R: 0.98, G: 0.94, B: 1.00, A: 0.86}, render.Color{R: 0.45, G: 0.26, B: 0.58, A: 1}),
	})
}
