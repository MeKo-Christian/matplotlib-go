...
//nolint:gocritic // Quiver options are immutable value snapshots used by redraw closures.
...
//nolint:gocritic // Quiver options are value-semantic public configuration.
...
//nolint:gocritic // Error-bar options are immutable value snapshots used by redraw closures.
...
//nolint:gocritic // Error-bar options are value-semantic public configuration.
...
//nolint:gocritic // Fixed-size projection matrices intentionally use arithmetic value semantics.
