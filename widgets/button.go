...
func (b *Button) Draw(r render.Renderer, ctx *core.DrawContext) {
...
func (b *Button) Bounds(ctx *core.DrawContext) geom.Rect {
	if b == nil || ctx == nil {
		return geom.Rect{}
	}
	defaults := widgetDefaultsForRC(&ctx.RC)
...
func (b *Button) Contains(p geom.Pt, ctx *core.DrawContext) (bool, core.PickInfo) {
	if b == nil || ctx == nil {
...
func mergeButtonOptions(base, override *ButtonOptions) {
