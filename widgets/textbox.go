...
func (t *TextBox) Contains(p geom.Pt, ctx *core.DrawContext) (bool, core.PickInfo) {
	if t == nil || ctx == nil {
		return false, core.PickInfo{}
	}
	return t.Bounds(ctx).Contains(p), core.PickInfo{}
}

func (t *TextBox) Draw(r render.Renderer, ctx *core.DrawContext) {
...
func (t *TextBox) Bounds(ctx *core.DrawContext) geom.Rect {
	if t == nil || ctx == nil {
		return geom.Rect{}
	}
	defaults := widgetDefaultsForRC(&ctx.RC)
...
func (t *TextBox) CaretForPoint(p geom.Pt, ctx *core.DrawContext) int {
	if t == nil || ctx == nil {
		return 0
	}
	defaults := widgetDefaultsForRC(&ctx.RC)
...
func mergeTextBoxOptions(base, override *TextBoxOptions) {
