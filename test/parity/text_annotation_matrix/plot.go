...
func addAnnotationMatrix(ax *core.Axes) {
	...
	ax.Annotate("clipped", -0.4, 4.7, core.AnnotationOptions{
		OffsetX:         optional.Of(pt(40)),
		OffsetY:         optional.Of(pt(-20)),
		AnnotationClip:  optional.Of(clip),
