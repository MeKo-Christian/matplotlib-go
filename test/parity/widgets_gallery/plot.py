...
def widgets_gallery(out_dir):
    ...
    main_ax.plot(x, signal, color=blue, linewidth=lw(2.2), label="signal")
    main_ax.plot(x, modulation, color=orange, linewidth=lw(1.7), label="modulation")
    ...
    main_ax.plot(lasso[:, 0], lasso[:, 1], color=(0.58, 0.40, 0.74), linewidth=lw(1.4))
    main_ax.axvline(2.8, color=(0.2, 0.2, 0.2), linewidth=lw(1.0), alpha=0.75)
    main_ax.axhline(0.35, color=(0.2, 0.2, 0.2), linewidth=lw(1.0), alpha=0.75)
    ...
    aux_ax.plot(x, modulation, color=orange, linewidth=lw(1.7))
    aux_ax.axvline(4.45, color=(0.2, 0.2, 0.2), linewidth=lw(1.0), alpha=0.75)
    aux_ax.axhline(0.0, color=(0.2, 0.2, 0.2), linewidth=lw(1.0), alpha=0.75)
